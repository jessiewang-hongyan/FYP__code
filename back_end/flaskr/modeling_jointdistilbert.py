...
from flaskr.module import IntentClassifier, SlotClassifier
...
class JointDistilBERT(DistilBertPreTrainedModel):
    ...
    def forward(self, input_ids, attention_mask, intent_label_ids, slot_labels_ids):
        outputs = self.distilbert(input_ids, hidden_statesattention_mask=attention_mask)  # last-layer hidden-state, (), (attentions)
